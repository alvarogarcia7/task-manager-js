...
ko.utils = (function () {
    ...
    return {
        ...
        unwrapObservable: function (value,modify) {
			var newObject={};
			
			if(undefined!=modify && typeof value == "object"){
				console.log("unwrapObservable:: is object");
				for (var attr in value) {
					newObject[attr] = ko.isObservable(value[attr]) ? value[attr]() : value[attr];
				}
				return newObject;
			} else {
        ...
        stringifyJson: function (data, replacer, space) {   // replacer and space are optional
            ...
            return JSON.stringify(ko.utils.unwrapObservable(data,true), replacer, space);
        },
